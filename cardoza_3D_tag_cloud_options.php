...
<div class="wrap tag-cloud-3d-admin">
    ...
    if(isset($_POST['frm_submit'])):
        if(!isset($_POST['cardozatagcloud_update_admin_options_nonce']) || !wp_verify_nonce($_POST['cardozatagcloud_update_admin_options_nonce'], 'cardozatagcloud_update_admin_options')):?>
            <div id="message" class="updated fade"><p><strong><?php _e('Sorry, your nonce did not verify.', 'wpcaptchadomain'); ?></strong></p></div>
        <?php else:
    ...
    <form method="post" action="">
        <?php wp_nonce_field('cardozatagcloud_update_admin_options', 'cardozatagcloud_update_admin_options_nonce');?>
